...
If SF1->F1_EST == 'EX'
	DEFINE MSDIALOG oDlg1 TITLE "Informações Complementares/Dados Bancarios Fornecedor" FROM C(195),C(226) TO C(682),C(755) PIXEL
	...
	@ C(191),C(075) MsGet occonta1 Var conta1 Size C(060),C(009) COLOR CLR_BLACK Picture "@!" PIXEL OF oDlg1
...
Else
	...
	@ C(040),C(050) MsGet occonta1 Var conta1 Size C(060),C(009) COLOR CLR_BLACK Picture "@!" PIXEL OF oDlg1
...
cQuery += " WHERE D1_FILIAL = '"+SF1->D1_FILIAL+"' AND D1_SERIE = '"+ SF1->F1_PREFIXO +"' AND D1_DOC = '"+SF1->F1_DUPL+"' "
