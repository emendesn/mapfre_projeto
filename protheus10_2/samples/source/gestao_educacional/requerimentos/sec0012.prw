...
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄ´±±
±±³ Revis„o  ³Icaro Queiroz / Ajuste na Query BOPS 127516³ Data ³30/Ago/07³±±
±±ÀÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÙ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
...
cQuery += " AND  SE1.E1_NRDOC    = '"+ Alltrim(aRet[1]) + Alltrim(aRet[3]) +"' "
cQuery += " AND  JBE.JBE_ATIVO  	= '1' "
cQuery += " AND  (SE1.E1_PREFIXO	= 'MAT' OR SE1.E1_PREFIXO = 'MES' OR SE1.E1_PREFIXO = 'DIS' OR SE1.E1_PREFIXO = 'REQ') "
cQuery += " GROUP BY "
