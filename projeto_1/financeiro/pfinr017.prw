...
cQuery += "SA1.A1_FILIAL = '" + xFilial("SA1") + "' "	//#JJ20140831.n
cQuery += "WHERE SE1.D_E_L_E_T_ <> '*' AND SE1.E1_FILIAL = '" + xFilial("SE1") + "' AND "	//#JJ20140831.n
cQuery += "SE1.E1_SALDO > 0 AND "
cQuery += "SE1.E1_VENCREA = '" + DTOS(dDtmail) + "' AND "
//cQuery += "SE1.E1_TIPO = 'NF' AND "	//#JJ20140831.o
cQuery += "SE1.E1_TIPO = 'NF' "	//#JJ20140831.n
