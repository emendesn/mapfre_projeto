...
@ 095,130 BUTTON OemToAnsi(STR0005) SIZE 55,13 ACTION Eval( { || fPerg_Word() , fWord_Imp() } )			//?-"Impr. _Documento"
...
aAdd( aExp, {'GPE_MUNICNASC'	,	if(SRA->(FieldPos("RA_MUNNASC")) # 0  ,SRA->RA_MUNNASC,space(20)), "@!"	,STR0166 	} )	//Municipio de Nascimento
