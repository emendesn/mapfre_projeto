...
±±³Fun‡„o    ³ PATIR001 ³ Autor ³ Gilberto Alvarenga    ³ Data ³Maio/2004 ³±±
...
//		_nSaldoBem := TRB->N3_VORIG1  - TRB->N3_VRDACM1
		_nTotalBx  := 0
...
//		@Prow(),110 PSAY TRB->N3_VRDMES1 Picture "@E 999,999,999.99"
//		@Prow(),125 PSAY TRB->N3_VRDACM1 Picture "@E 999,999,999.99"
		...
		_nAcDMes  += _nMesDep // TRB->N3_VRDMES1
		_nAcDAcu  += _nAcuDep // TRB->N3_VRDACM1
