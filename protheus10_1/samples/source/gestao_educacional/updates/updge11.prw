	...
	******************************************************************************************/
	...
	For i:= 1 To Len(aSX3)
		...
		If !Empty(aSX3[i][1])
			...
			if Empty(cTexto)
				cTexto  += "Campo(s) atualizado(s): "+aSX3[i,3]
			else
				cTexto  += " / "+aSX3[i,3]
			endif
...
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³ Funcao para criacao dos parametros MV_ACEXBOL e MV_ACBLDLB ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³ Uso      ³ Atualizacao GE                                             ³±±
±±ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
...
/*********************************************************************************************
Define os dados dos parametros
********************************************************************************************/
aadd(aSx6,{	cCodFilial,;											//Filial
			...
			"se o mesmo encontrar-se verdadeiro.",; 	 			//Desc1
			"se o mesmo encontrar-se verdadeiro.",; 				//DscSpa1
			"se o mesmo encontrar-se verdadeiro.",; 				//DscEng1
			"",;	 												//Desc2
			"",;													//DscSpa2
			"",;													//DscEng2
			"F",;													//Conteud
...
For i:= 1 To Len(aSx6)
	If !Empty(aSx6[i,2])
		...
		MsUnLock()
		if Empty(cTexto)
			cTexto  += "Parametro(s) atualizado(s): "+aSx6[i][2]
		else
			cTexto  += " / "+aSx6[i][2]
		endif
	EndIf
