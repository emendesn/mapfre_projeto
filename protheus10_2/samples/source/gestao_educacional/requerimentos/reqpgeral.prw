...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function ReqPGeral( nRAPer, cProt, nDiscip, nCodCur )
...
nCodCur   := Iif( nCodCur   == NIL, 0, nCodCur   )
...
Else	// Aluno
	...
	If ! JBE->( dbSeek( xFilial( "JBE" ) + "1" + SubStr( JBH->JBH_CODIDE, 1, TamSX3("JA2_NUMRA")[1] ) + Iif(nCodCur > 0, aRet[nCodCur], "") ) )
	
		JBE->( dbSetOrder( 1 ) )
		JBE->( dbSeek( xFilial( "JBE" ) + SubStr( JBH->JBH_CODIDE, 1, TamSX3("JA2_NUMRA")[1] ) + Iif(nCodCur > 0, aRet[nCodCur], "") ) )
