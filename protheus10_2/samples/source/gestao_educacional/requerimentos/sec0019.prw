...
AAdd( aDados, { "DATA"		,AllTrim(SM0->M0_CIDCOB)+"São Paulo, " + SubStr(DtoC(dDataBase),1,2) + " de " + MesExtenso(Val(SubStr(DtoC(dDataBase),4,2))) + " de " + AllTrim(Str(Year(dDataBase))) })

// Eliminado conf. Bops 112677 (11/01/06) P.Seidinger por dualidade com o período, informado anteriormente.
