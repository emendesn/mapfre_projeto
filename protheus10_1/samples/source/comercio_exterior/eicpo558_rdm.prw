...
AVPRINT oPrn NAME STR0009 //"Commercial Invoice"
   ...
   AVPAGE
        ...
        DO WHILE ! SW7->(EOF()) .AND. SW7->W7_FILIAL == xFilial("SW7") .AND. SW7->W7_HAWB == cHouse
           ...
           nLi_Fim:=nLinha
           PO558VerFim(1)
           oPrn:Say( nLinha,500  ,STR0025+alltrim(trans(SW7->W7_QTDE*W5Peso(),AVSX3("W6_PESO_BR",6)+STR0013)), aFontes:TIMES_NEW_ROMAN_12) //"PESO LIQUIDO: "###" KGS" //FCD 04/07/01  //ASR 27/01/2006 - AVSX3("B1_PESO",6)
           nLinha := nLinha + 50
        ...
        oPrn:Say( nLinha   ,2180 ,trans(SW6->W6_FRETEIN,AVSX3("W6_FRETEIN",6)), aFontes:TIMES_NEW_ROMAN_12 ,,,,1)  //TRP-18/02/08  
        //nFob_Tot := nFob_Tot + SW6->W6_FRETEIN * nPari_1
        nFob_Tot := nFob_Tot + SW6->W6_FRETEIN  //TRP-18/02/08
        PO558VerFim(2)
        ...
        oPrn:Say( nLinha ,2180 ,trans(SW6->W6_INLAND,AVSX3("W6_INLAND",6)), aFontes:TIMES_NEW_ROMAN_12 ,,,,1) //TRP-18/02/08
        //nFob_Tot := nFob_Tot + SW6->W6_INLAND * nPari_1
        nFob_Tot := nFob_Tot + SW6->W6_INLAND  //TRP-18/02/08
        PO558VerFim(2)
        nLinha := nLinha + 50
        ...
        oPrn:Say( nLinha ,2180 ,trans(SW6->W6_PACKING,AVSX3("W6_PACKING",6)), aFontes:TIMES_NEW_ROMAN_12 ,,,,1)  //TRP-18/02/08
        //nFob_Tot := nFob_Tot + SW6->W6_PACKING * nPari_1
        nFob_Tot := nFob_Tot + SW6->W6_PACKING  //TRP-18/02/08
        PO558VerFim(2)
        nLinha := nLinha + 50
        ...
        oPrn:Say( nLinha ,2180 ,trans(SW6->W6_DESCONT,AVSX3("W6_DESCONT",6)), aFontes:TIMES_NEW_ROMAN_12,,,,1)  //TRP-18/02/08
        //nFob_Tot := nFob_Tot - SW6->W6_DESCONT * nPari_1
        nFob_Tot := nFob_Tot - SW6->W6_DESCONT  //TRP-18/02/08 
        PO558VerFim(2)
        nLinha := nLinha + 50
        ...
        IF ! EMPTY(SW2->W2_EXPORTA)  //TRP-03/09/07
