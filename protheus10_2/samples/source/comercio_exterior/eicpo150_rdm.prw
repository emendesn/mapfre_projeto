...
pTipo := 6
PO150BateTraco()
oSend( oPrn, "Say",  Linha, 1250 , LITERAL_OTHER_EXPEN , aFontes:COURIER_08_NEGRITO )
oSend( oPrn, "Say",  Linha,2100, TRANS(SW2->W2_DESCONT,E_TrocaVP(nIdioma,'@E 999,999,999,999.99')), aFontes:TIMES_NEW_ROMAN_08_NEGRITO,,,,1 )
Linha := Linha+50
...
nTotalGeral := (nTotal+SW2->W2_INLAND+SW2->W2_PACKING+SW2->W2_FRETEINT+SW2->W2_OUT_DES)-SW2->W2_DESCONT
