...
ฑฑบPrograma  ณPFINR230  บAutor  ณTrade               บ Data ณ  09/04/08   บฑฑ
...
Local cDesc3       := "Rela็ใo de Titulos Contas เ Receber. Projeto 6 Sigma"
Local cPict        := ""
Local titulo       := "Rela็ใo de Titulos Contas a Receber - Projeto 6 Sigma: " + IIF(MV_PAR08==1, "Natureza", "Cliente")
Local nLin         := 80
