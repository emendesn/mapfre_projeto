...
ฑฑภฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
...
If mv_par07 == 1
   ...
   Else
      cArq := cArquivo // +".DBF"
      cArqExcel := "\PROTHEUS_DATA\RELATO\"+cArq+".XLS"
      Copy To &cArqExcel
      oExcelApp:= MsExcel():New()
      oExcelApp:WorkBooks:Open(cArqExcel)
      oExcelApp:WorkBooks:Open("\PROTHEUS_DATA\RELATO\"+cArq+".XLS")
...
Do While !EOF()
	...
	Do While IIF(MV_PAR08==2,TRB->CODIGO == _cliente .AND. TRB->LOJA == _cLoja, TRB->NATUREZA == _cliente)
       ...
       If TRB->VENC_REA < IIF(MV_PAR09 == 1, dDataBase, mv_par04)
   	      ...
   	      @ nLin,145 PSAY IIF(MV_PAR09 == 1, dDataBase, mv_par04) - TRB->VENC_REA	PICTURE "9999"
