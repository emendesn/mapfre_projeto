...
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³02/01/15  ³#JJ20150102 - Correcao [SOCKCLIENT] Error [54] The          ³±±
...
While ! SQLSE1->(EOF())
	...
	//MailAuth(cAccount, cPassword)	//#JN20150102.o
	
	If lConectou
		
		If ! MailAuth(cAccount, cPassword)	//#JN20150102.n
			Get Mail Error cErrorMsg	//#JN20150102.n
			ConOut("PFINR014.PRW - "+cErrorMsg)	//#JN20150102.n
			///
		Else	//#JN20150102.n
