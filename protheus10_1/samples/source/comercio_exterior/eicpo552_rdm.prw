...
AVPRINT oPrn NAME STR0043 //"EmissÒo de InstruþÒo de Embarque / Shipping Instructions"
   ...
   AVPAGE
        ...
        DO WHILE ! Work1->(EOF())
           ...
           If Empty(aItens)    
              Aadd(aItens,{SW5->W5_COD_I, SW5->W5_QTDE , mDescri, SW5->W5_PRECO, SW5->W5_QTDE * SW5->W5_PRECO, DATA_ITEM })
           Else             
              If (nItem:=aScan(aItens, {|x| x[1] == SW5->W5_COD_I})) == 0
                 Aadd(aItens,{SW5->W5_COD_I, SW5->W5_QTDE , mDescri, SW5->W5_PRECO, SW5->W5_QTDE * SW5->W5_PRECO, DATA_ITEM })
              Else              
                 AItens[nItem][2] += SW5->W5_QTDE
                 AItens[nItem][5] += SW5->W5_QTDE * SW5->W5_PRECO
              EndIf  
           EndIf   
        ...
        //ASK 15/10/2007 - Tratamento para Embarque com mais de um P.O.
           ...
           oPrn:Say( nLinha    ,490  ,memoline(aItens[j][3],25,1),ofont1)
           oPrn:Say( nLinha    ,1680 ,trans(aItens[j][4],E_TrocaVP(nIdioma,_PictPrUn)),aFontes:TIMES_NEW_ROMAN_12,,,,1)
           oPrn:Say( nLinha    ,2075 ,trans(aItens[j][5],E_TrocaVP(nIdioma,_PictPrUn)),aFontes:TIMES_NEW_ROMAN_12,,,,1)
           oPrn:Say( nLinha    ,2120 ,aItens[j][6], aFontes:TIMES_NEW_ROMAN_12)
